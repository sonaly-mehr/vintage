...
const Instrument = () => {
  ...
  return (
    <div>
      <div className="width">
        <h4 className="heading text-[#3F3F3F] pt-16 pb-4">
        ...
        <div className="width flex justify-between">
          ...
          <div className="flex items-center gap-16">
            <div className="flex items-center gap-5">
              <Link
                href="/"
                className={`${gridView ? "black" : "text-[#979797]"} text-3xl`}
              ...
              <Link
                href="/"
                className={`${gridView ? "text-[#979797]" : "black"} text-3xl`}
      ...
      <div className="width pt-5 pb-16">
