...
const page = () => {
  return (
    <>
      ...
      <div className="width">
        <h1 className="heading pt-10 pb-4">korábbi Foglalásod</h1>
      </div>
      ...
      <div className="bg-[#F8E3E3] py-10">
        <div className="width flex gap-28 items-center">
          <h6 className="text-[15px] font-bold leading-[23px]">
            Foglalásaid <br /> ára összesítve:
          </h6>
          <h6 className="text-[15px] font-bold leading-[23px]">190 000 Ft</h6>
        </div>
      </div>
